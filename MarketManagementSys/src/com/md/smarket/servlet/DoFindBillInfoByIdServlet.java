...
public class DoFindBillInfoByIdServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int txtBillId = Integer.parseInt(request.getParameter("billId"));
		BillMangeServiceImpl billMangeServiceImpl = new BillMangeServiceImpl();
		BillDao billDao = new BillDaoImpl();
		billMangeServiceImpl.setBillDao(billDao);
		Bill bill=billMangeServiceImpl.findBillInfoById(txtBillId);
		if (bill != null) {
